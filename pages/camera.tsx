  ...
  useEffect(() => {
    ...
    const chromaKey = async (segmenter: any) => {
      if (
        ...
        const frame = context.getImageData(0, 0, canvas2.width, canvas2.height);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <div className="flex flex-col">
        ...
        <canvas
          ref={chromaRef}
          className="max-w-screen absolute left-[50%] top-[50%] z-20  max-h-screen  -translate-y-[50%] -translate-x-[50%] rotate-90 bg-transparent"
        />
