<template>
  <div class="textcontent-wrap" v-if="data">
    <div
      v-if="data"
      :class="{
        active: showMore === true && letterCounter(data) > 3500,
        cut: letterCounter(data) > 3500 && showMore === false
      }"
      class="block-content-textcontent"
    >
      <div v-html="this.data" />
      <div class="counter" v-html="letterCounter(data) + ' chars'" />
    </div>
    <fragments-more-button
      v-if="letterCounter(data) > 3500"
